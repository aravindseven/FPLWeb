...
<html ng-app="fpl">
	<head>
		...
		<script type="text/javascript" src="support/script/angularJS/angular.min.js.map"></script>
		...
		<script type="text/javascript" src="support/controller/EntityDBController.js"></script>
...
<div class="mainWrapper" ng-controller="UserLoginController as uLogin">
	...
	<!-- Settings Content -->
	<jsp:include page="/include/admin/EntityDB.jsp" flush="true" />
