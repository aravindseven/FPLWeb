...
<div ng-init="uCommunication.compose();uCommunication.getsession()" class="tab-pane active maildiv" id="maildiv">
	<div class="tab-pane active" id="tab_b" ng-hide="mailread">
		...
		<div class="col-lg-12 content">
			<div class="row" ng-repeat="inbox in sentList" ng-cloak>
				<div class="col-lg-12 fontsizes">
					<div class="row">
						<div class="col-lg-3 subclass">
							...
							<!-- <div class="name"><img src="support/communication/images/qq.png" alt=""/></div> -->
							...
							<div ng-if="inbox.threadmsg.length!=1">
								<div class="name_left ng-cloak" ng-if="inbox.MI_TO_ID!=currentUser.UserId">To: {{ usersListbyID[inbox.MI_TO_ID].user+" ("+inbox.threadmsg.length+")" }}</div>
								<div class="name_left ng-cloak" ng-if="inbox.MI_TO_ID==currentUser.UserId">To: {{ usersListbyID[inbox.MI_FROM_ID].user+" ("+inbox.threadmsg.length+")" }}</div>
							</div>
							<div ng-if="inbox.threadmsg.length==1">
								<div class="name_left ng-cloak" ng-if="inbox.MI_TO_ID!=currentUser.UserId">To: {{ usersListbyID[inbox.MI_TO_ID].user }}</div>
								<div class="name_left ng-cloak" ng-if="inbox.MI_TO_ID==currentUser.UserId">To: {{ usersListbyID[inbox.MI_FROM_ID].user }}</div>
							</div>
						</div>
	...
	<div class="tab-pane active" ng-show="mailread" ng-cloak>
		<div class="panel-group">
			<div class="panel panel-default noborder" ng-repeat="thread in readMail.threadmsg">
				...
				<!-- <div id="collapse-{{$index+1}}" class="panel-collapse collapse" ng-class="$index+1==readMail.threadmsg.length && replymail=='false' ?'in':''" ng-cloak>
