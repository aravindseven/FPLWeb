(function (window, document, $, undefined) {
    ...
    var possibleCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";/*"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";*/
    ...
    CAPTCHA.prototype = {
        ...
        generate: function () {
            ...
            if (this._settings.randomColours) {
            	//modified by haripriya to change the background color to alice blue
               // this._settings.colour1 = this._generateRandomColour();
                this._settings.colour1 = '#F0F8FF';
            ...
            //modified by haripriya to decrease random curves
            var numRandomCurves = Math.floor((Math.random() * 6) + 2);
        ...
        _drawRandomCurve: function () {
            ...
            ctx.lineWidth = Math.floor((Math.random() * 4) + 4);
