...
public class GetInboxMessagesController extends AjaxBaseController {
	@Autowired
	...
	public ModelAndView executeAjaxCall(final HttpServletRequest request, final HttpServletResponse response) {
		...
		try {
			...
			if(search==null || search.isEmpty())
			{
				...
				stats = communicationManager.getInbox(loginInfo.getLoginCredentialid(),Integer.parseInt(request.getParameter("pageno")),filter);
