...
public class ReadstatusController extends AjaxBaseController {
...
/*try {
	...
	Boolean stats = communicationManager.Readstatus(readstatus,loginInfo.getLoginCredentialid());
	System.out.println("Storechatmsgscontroller"+readstatus);
	map.put("Status", "Success");
	map.put("Result", stats);
	map.put("recsen_id", loginInfo.getLoginCredentialid());
