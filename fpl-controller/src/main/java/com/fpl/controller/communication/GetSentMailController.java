...
public class GetSentMailController extends AjaxBaseController {
	@Autowired
		...
		try {
			...
			if(search==null || search.isEmpty())
			{
				System.out.println("calledserch is null");
				 stats = communicationManager.getSentMail(loginInfo.getLoginCredentialid(),Integer.parseInt(request.getParameter("pageno")),filter);
			...
			else
			{
				...
				if(("SENT").equalsIgnoreCase(request.getParameter("box")))
				{
