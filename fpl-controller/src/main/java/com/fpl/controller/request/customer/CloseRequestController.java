...
public class CloseRequestController extends AjaxBaseController {
	...
	public ModelAndView executeAjaxCall(final HttpServletRequest request, final HttpServletResponse response) {
		...
		final String description = "Request Closed";
		...
		respondRequest.setStatus("ST_03");
		...
		return new ModelAndView("fplajax_acceptRequest", resMap);
