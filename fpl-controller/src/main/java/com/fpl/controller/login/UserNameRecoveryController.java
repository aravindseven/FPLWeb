...
public class UserNameRecoveryController extends AjaxBaseController {
	...
	public ModelAndView executeAjaxCall(final HttpServletRequest request, final HttpServletResponse response) {
		...
		final FPLServiceResponse serviceResponse = loginServices.recoverUserName(loginParam, request);
