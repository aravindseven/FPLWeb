...
public class CommunicationSentMailController extends AjaxBaseController {
	...
	public ModelAndView executeAjaxCall(HttpServletRequest request,
		...
		try {
			...
			store.connect("imap.gmail.com", "mailId@gmail.com",
					"Password");
			...
			sentMail = store.getFolder("[Gmail]/Sent Mail");
			sentMail.open(Folder.READ_ONLY);

			Message messages[] = sentMail
